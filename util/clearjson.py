...
logging.basicConfig(filename="/home/pi/catfiles/catfeeder.log",
                            filemode='a',
...
with open('/home/pi/catfiles/catdata.json') as json_file:
...
with open('/home/pi/catfiles/catdata.json', 'w') as f:
